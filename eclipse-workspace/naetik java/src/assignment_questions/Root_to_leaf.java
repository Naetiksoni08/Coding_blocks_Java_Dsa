...
public class Main {
 ...
 static private Node root;
	...
	public void rootToLeaf(Node root,int k, List<Integer> ll,int sum) {
		
		if (root == null) {
			return;
		}
		ll.add(root.data);
		sum += root.data; // or k-=root.data 
		...
		rootToLeaf(root.left,k,ll,sum);
		rootToLeaf(root.right,k, ll,sum);
	...
	public static void main(String[] args) {
		...
		b1.rootToLeaf(root, k, new ArrayList<>(), 0);
	}
